\section{Data from energy up to 1000PE}
This analysis discuss recoil energies up to 240\,keV (180\,PE) due to low statistics in calibration of NRs. For completeness the data of energy recoils of up to 1000\,PE is presented in Fig~\ref{fig:eft_1000}. The quality selection criteria applied are the same as for the highE region.

\begin{figure}
\centerline{\includegraphics[width=1.\linewidth]{Figures/eft_1000.eps}}
\caption{In blue, ER calibration sample ($^{60}$Co and $^{232}$Th). In black Dark Matter data sample. The two large populations in ~350\,PE and ~500\,PE are the 110\,keV and 197\,keV excitation lines of $^{19}F$ coming from the PTFE and occurring at the outskirts of the FV. }
\label{fig:eft_1000}
\end{figure}  
