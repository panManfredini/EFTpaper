...
is bounded in y space from above by the 99.75\% ER rejection line and below by the lower 3$\sigma$ quantile of the AmBe neutron calibration data. The expected background in the region is $1.7 \pm 0.3$ (lowE) and $1.67 \pm 0.33$ (highE). The number of DM candidates recorded in this region is 1 (lowE), and 4 (highE). }
