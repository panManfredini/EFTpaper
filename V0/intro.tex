...
%The detector consists a total of 242\,1-inch square Hamamatsu R8520-AL photomultiplier tubes (PMTs) employed in two arrays,  %FIXME  check what's the number of PMTs % Ran Itay - This is copied from Xenon paper so I dont think needs to be correct, and I think should be written.
