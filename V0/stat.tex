...
The high energy channel analysis employs a binned likelihood function. Observed and expected event yield are compared in the nine ROI \RanComment{Also here y-cS1}(cS1,cS2)-bins described in section~\ref{subsubsec:HighE}. 
