...
We define our signal region in the discrimination space (log(S2/S1) Vs S1). The upper bound is defined by taking the NR calibration sample mean and scaling it up such that in 30PE it coincide with the ER mean. The lower is defined by taking $3\sigma$ from the NR mean, this is done for preventing gamma-X events to penetrate the sample.
