...
The range in cS1 is constrained instead to be within 3 and 30\,PE \RanComment{instead of what?}. This  ROI is further divided into WIMP mass dependent sub-regions (also called bands) arranged in a way 
