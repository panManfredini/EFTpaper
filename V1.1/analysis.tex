...
\sout{The regions of interests (ROI) in these two channels, in which we search for dark matter events, are shown in Figure~\ref{fig:phasespace} and further described in the following sections.} 
