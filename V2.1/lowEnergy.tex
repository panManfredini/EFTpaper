...
\ale{Note that}
%Finally, 
this analysis channel does not employ a variable lower S1 threshold as a function of the event position in the TPC, but \BenComment{instead applies} a fixed lower threshold cut on cS1 at 3\,PE, \ale{conversely} to \BenComment{the choice made in}~\cite{xe100_run_combination}.
...
have been evaluated and propagated to each band \BenComment{*This sentence doesn't make sense; missing an "and" or something? I can't quite guess what it is supposed to mean*}
