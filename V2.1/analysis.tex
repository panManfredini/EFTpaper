...
\resizebox{1.\columnwidth}{!}{
 ...
 \hline
 1 & upper & 30  - 40  & 23.5$\pm$5.09 & 20 \\ 
 
 2 & upper & 40  - 50  & 15.7$\pm$3.46 & 17 \\
 
 3 & upper & 50  - 80  & 12.4$\pm$2.76 & 11 \\
 
 4 & upper & 80  - 120 & 1.1$\pm3.04\times 10^{-1}$  & 1  \\
 
 5 & upper & 120 - 150 & 0.1$\pm4.55\times 10^{-2}$  & 1  \\  
 
 6 & upper & 150 - 180 & 0.08$\pm3.88\times 10^{-2}$ & 0  \\  
 
 7 & lower & 30  - 50  & 0.9$\pm2.56\times 10^{-1}$  & 0  \\  
 
 8 & lower & 50  - 90 & 0.35$\pm1.18\times 10^{-1}$ & 0  \\  
 
 9 & lower & 120 - 180 & 0.18 $\pm7.03\times 10^{-2}$& 0  \\  
 \hline\hline
\end{tabular}
}
...
Figures ~\ref{fig:HighE} and \ref{fig:LowE} shows dashedsignal distribution examples for two EFT operators and for the low and the high energy region, respectively.
