...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Finally, this channel does not employ a variable lower S1 threshold as a function of the event position \BenComment{in the TPC}, but a fixed 
lower threshold cut on cS1 at 3\,PE, converse to what was \BenComment{done} in~\cite{xe100_run_combination}.
